...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Insurance Claim Submission.create': {
    roles: ['system-administrator', 'healthcare-provider', 'medical-staff'],
    key: 'Insurance Provider',
    tenantPath: [],
    userPath: [],
  },
  'Appointment Scheduling.create': {
    roles: ['system-administrator', 'healthcare-provider', 'medical-staff', 'patient'],
    key: 'Healthcare Provider',
    tenantPath: [],
    userPath: [],
  },
  'Medical Record Update.update': {
    roles: ['system-administrator', 'healthcare-provider', 'medical-staff', 'patient'],
    key: 'Medical Staff',
    tenantPath: [],
    userPath: [],
