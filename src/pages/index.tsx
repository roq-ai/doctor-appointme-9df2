  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless healthcare with Doctor Appointment System v1 - Your one-stop solution for scheduling, tracking, and managing your medical appointments effortlessly"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1651008376811-b90baee60c1f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkb2N0b3J8ZW58MHx8fHwxNjk1MTg0NTU1fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless healthcare with Doctor Appointment System v1 - Your one-stop solution for scheduling, tracking, and managing your medical appointments effortlessly`}
            </Text>
            <Box
